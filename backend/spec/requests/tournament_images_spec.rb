...
RSpec.describe "TournamentImages", type: :request do
  it "allows admin to upload and participants to view" do
    admin = User.create!(
      name: "運営",
      name_kana: "ウンエイ",
    ...
    6.times do |i|
      user = User.create!(
        ...
        name_kana: "メンバー#{i}",
        birth_date: "1990-01-01",
        phone: "090-0000-400#{i}",
        email: "mem11-#{i}@example.com",
        address: "東京都",
        password: "password"
      )
    ...
    post "/tournaments/#{tournament_id}/images", params: {
